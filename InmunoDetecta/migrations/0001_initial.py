    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula_medico', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InmunoDetecta.medico')),
                ('cedula_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InmunoDetecta.paciente')),
            ],
        ),
    ]
